...
import cleanPark from './imgs/site-assets/soupkitchen.jpg'
    ...
    <section>
        <div className="row">
            <div className="small-1 columns">
                <Link to='/event12'><img className="arrow" src={left} alt="next" /></Link>
            </div>
            <div className="small-10 columns">
                <img className="ev-img big float-center" src={cleanPark} alt="" />
                <h4 className="ev-title big">Biscuits with Bob</h4>
                <p className="ev-comp big">Bob{"'"}s Soup Kitchen</p>
                <p className="ev-date big">7/13/17</p>
            ...
            <div className="small-1 columns">
                <Link to="/event1"><img className="arrow" src={right} alt="next" /></Link>
            </div>
        </div>
    </section>
    </div>
