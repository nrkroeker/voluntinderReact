...
import cleanPark from './imgs/site-assets/cleanup.gif'
    ...
    <section>
        <div className="row">
            <div className="small-1 columns">
                <Link to="/event4"><img className="arrow" src={left} alt="next" /></Link>
            </div>
            <div className="small-10 columns">
                <img className="ev-img big float-center" src={cleanPark} alt="" />
                <h4 className="ev-title big">#CleanIndy</h4>
                <p className="ev-comp big">Indy Parks and Recreation Assc.</p>
                <p className="ev-date big">11/11/11</p>
            ...
            <div className="small-1 columns">
                <Link to='/event12'><img className="arrow" src={right} alt="next" /></Link>
            </div>
        </div>
    </section>
    </div>
